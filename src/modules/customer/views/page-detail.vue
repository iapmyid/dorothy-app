...
<template>
  <div class="main-content-container">
    <div class="main-content-header">
      ...
      <component :is="BaseBreadcrumb" :breadcrumbs="[{ name: 'Customer', path: '/customer' }, { name: '1' }]" />
    </div>
      ...
      <div class="card card-template">
        <div class="card-header">
          ...
          <div class="flex gap-2 overflow-x-hidden">
            ...
            <div>
              <router-link to="/customer/1/edit" class="btn btn-secondary btn-sm rounded-none space-x-1">
